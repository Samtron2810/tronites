    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 px-4">
      <div className="bg-card rounded-2xl shadow-xl p-6 w-full max-w-sm">
        ...
        <label className="block mt-4">
          <span className="block text-sm font-medium text-ink-sub mb-1.5">
          ...
          <input
            ...
            autoFocus
            disabled={isDeleting}
            className="w-full px-3.5 py-2.5 rounded-xl border border-stroke bg-card text-ink text-base outline-none focus:border-primary-600 focus:ring-2 focus:ring-primary-100 transition disabled:opacity-60"
