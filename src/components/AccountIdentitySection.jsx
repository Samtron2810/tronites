...
const FieldRow = ({
  ...
  return (
    <div className="py-4 first:pt-0 last:pb-0">
      ...
      <p className="text-xs text-ink-muted mb-3">{helperText}</p>
      {children}
    </div>
  );
};
        ...
        {!editingName ? (
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              ...
              disabled={nameLocked}
              className="inline-flex items-center gap-1.5 text-xs font-medium text-primary-600 hover:text-primary-800 disabled:opacity-40 disabled:cursor-not-allowed disabled:text-ink-muted transition shrink-0"
            >
              <FiEdit2 size={12} />
              Edit
            </button>
          ...
          <div className="space-y-2">
            <div className="grid grid-cols-2 gap-2">
              <input
                ...
                maxLength={30}
                autoFocus
                className="w-full px-3 py-2 rounded-xl border border-stroke bg-surface text-ink text-sm outline-none focus:border-primary-600 focus:ring-2 focus:ring-primary-100 transition"
              />
              <input
                type="text"
                value={lastName}
            ...
            <div className="flex gap-2">
              <button
                ...
                disabled={savingName}
                className="px-3.5 py-1.5 rounded-lg bg-primary-600 hover:bg-primary-800 disabled:opacity-50 text-white text-xs font-medium transition"
              >
              ...
              <button
                ...
                disabled={savingName}
                className="px-3.5 py-1.5 rounded-lg border border-stroke text-ink-muted text-xs font-medium hover:bg-surface transition"
              >
                Cancel
              </button>
            </div>
          ...
          <div className="space-y-2">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-7 pr-8 py-2 rounded-xl border border-stroke bg-surface text-ink text-sm outline-none focus:border-primary-600 focus:ring-2 focus:ring-primary-100 transition"
              />
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-3.5 py-1.5 rounded-lg bg-primary-600 hover:bg-primary-800 disabled:opacity-50 disabled:cursor-not-allowed text-white text-xs font-medium transition"
              >
